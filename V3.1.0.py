...
ImageBlanc = PhotoImage(file="C:\Program Files (x86)\Démineur\ImageBlanc.png")
ImageDrapeau = PhotoImage(file="C:\Program Files (x86)\Démineur\ImageDrapeau.png")
ImageDrapeauVrai = PhotoImage(file="C:\Program Files (x86)\Démineur\ImageDrapeauVrai.png")
ImageDrapeauFaux = PhotoImage(file="C:\Program Files (x86)\Démineur\ImageDrapeauFaux.png")
ImageVert = PhotoImage(file="C:\Program Files (x86)\Démineur\Vert.png")
ImageRouge = PhotoImage(file="C:\Program Files (x86)\Démineur\Rouge.png")
ImageBombe = PhotoImage(file="C:\Program Files (x86)\Démineur\ImageBombe.png")
ImageBombeFaux = PhotoImage(file="C:\Program Files (x86)\Démineur\ImageBombeFaux.png")
ImagesNuméros = [0]*9
ImagesNuméros[0] = PhotoImage(file="C:\Program Files (x86)\Démineur\Pic0.png")
ImagesNuméros[1] = PhotoImage(file="C:\Program Files (x86)\Démineur\Pic1.png")
ImagesNuméros[2] = PhotoImage(file="C:\Program Files (x86)\Démineur\Pic2.png")
ImagesNuméros[3] = PhotoImage(file="C:\Program Files (x86)\Démineur\Pic3.png")
ImagesNuméros[4] = PhotoImage(file="C:\Program Files (x86)\Démineur\Pic4.png")
ImagesNuméros[5] = PhotoImage(file="C:\Program Files (x86)\Démineur\Pic5.png")
ImagesNuméros[6] = PhotoImage(file="C:\Program Files (x86)\Démineur\Pic6.png")
ImagesNuméros[7] = PhotoImage(file="C:\Program Files (x86)\Démineur\Pic7.png")
ImagesNuméros[8] = PhotoImage(file="C:\Program Files (x86)\Démineur\Pic8.png")   
